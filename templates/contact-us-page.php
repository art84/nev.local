...
?>
    ...
    <div class="container info-container">
        <div class="text1">
        <p>
            Feel free to <a href="">contact us</a> to find out more about Craig's Couriers express courier service.
        </p>
        </div>
            ...
            <div class="text2">
                <p>
                    If you would like to get in contact with our CEO <span class="red-text">Steve Orenstein</span>
                    please email <span class="red-text">steve@zoom2u.com</span>
                </p>
                <p>
                    Craig's Couriers is 100% owned by Zoom2u Pty Ltd (ABN: 70 169 869 327)
                </p>
            </div>
    </div>